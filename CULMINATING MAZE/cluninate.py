...
pygame.mixer.music.load('song.mp3') # load background music 
pygame.mixer.music.play(-1) # play and loop background music


background = pygame.image.load("background.png")    # declare all background images
...
bert = pygame.image.load("bert.png")    # load bert picture
bert = pygame.transform.scale(bert, (600, 600)) # transform bert picture size 

tv = pygame.image.load("tv.png")    # load tv picture

wall = pygame.image.load("coral.png")    # load wall picture
...
character = pygame.image.load("flopper.png")    # load player character image
...
pygame.mixer.music.load('endsong.mp3')  # load ending music
...
nle = pygame.image.load("nlefloppa.png")    # load nle floppa picture
